def create_new_user
  @new_user ||= { :name => "Joo", :email => "joo@gmail.com",
...
def create_user
  create_new_user
  delete_user
  @user = FactoryGirl.create(:user, @new_user)
end
...
When /^I sign up with an invalid email$/ do
 create_new_user
  @new_user = @new_user.merge(:email => "it's a not nemail")
  sign_up
end

When /^I sign up without a password confirmation$/ do
  create_new_user
  @new_user = @new_user.merge(:password_confirmation => "")
  sign_up
end

When /^I sign up without a password$/ do
  create_new_user
  @new_user = @new_user.merge(:password => "")
  sign_up
end

When /^I sign up with a mismatched password confirmation$/ do
  create_new_user
  @new_user = @new_user.merge(:password_confirmation => "qwerty123")
  sign_up
end
...
When /^I sign in with a wrong email$/ do
  @new_user = @new_user.merge(:email => "joo@gmail.com")
  sign_in
end

When /^I sign in with a wrong password$/ do
  @new_user = @new_user.merge(:password => "wrong password")
  sign_in
end
...
When /^I edit my email address$/ do
  click_link "Edit account"
  fill_in "user_email", :with => "newjoemail@gmail.com"
  fill_in "user_current_password", :with => @new_user[:password]
end
...
When(/^I edit my email address with an invalid email$/) do
  click_link "Edit account"
  fill_in "user_email", :with => "it's not email"
  fill_in "user_current_password", :with => @new_user[:password]
end
